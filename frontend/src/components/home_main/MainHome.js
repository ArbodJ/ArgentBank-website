...
import iconChat from '../../assets/img/icon-chat copy.png';
import iconMoney from '../../assets/img/icon-money copy.png';
import iconSecurity from '../../assets/img/icon-security copy.png';
